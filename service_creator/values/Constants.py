...
I_FILENAME_DESC = Colors.WARNING + "Notice that if your file contains the \"#!/bin/bash\" header, it must be at the " \
                                   "first line of the file. If it is not present, it will be added automatically" \
                  + Colors.END_COLOR
